...
get_att(int ncid, int varid, const std::string& attname, std::error_code &ec) noexcept
    { return detail::get_att<T>(ncid, varid, attname, &ec); }

template <class T>
typename std::enable_if_t<std::is_arithmetic_v<T>, T>
get_att(int ncid, int varid, const std::string& attname)
    { return detail::get_att<T>(ncid, varid, attname); }
...
get_att(int ncid, int varid, const std::string& attname, std::error_code& ec)
    { return detail::get_att<T>(ncid, varid, attname, &ec); }
...
get_att_array(int ncid, int varid, const std::string& attname, std::error_code &ec)
    { return detail::get_att_array<Container>(ncid, varid, attname, &ec); }

template <class Container>
typename std::enable_if_t<std::is_arithmetic_v<typename Container::value_type>, Container>
get_att_array(int ncid, int varid, const std::string& attname)
    { return detail::get_att_array<Container>(ncid, varid, attname); }
...
get_att_array(int ncid, int varid, const std::string& attname, std::error_code &ec)
    { return detail::get_att_array<Vector>(ncid, varid, attname, &ec); }

template <class Vector>
typename std::enable_if_t<std::is_same_v<typename Vector::value_type, std::string>, Vector>
get_att_array(int ncid, int varid, const std::string& attname)
    { return detail::get_att_array<Vector>(ncid, varid, attname); }


// Get variable with arithmetic type.

template <class Container>
typename std::enable_if_t<std::is_arithmetic_v<typename Container::value_type>, Container>
get_var(int ncid, int varid, std::error_code& ec)
    { return detail::get_var<Container>(ncid, varid, &ec); }

template <class Container>
typename std::enable_if_t<std::is_arithmetic_v<typename Container::value_type>, Container>
get_var(int ncid, int varid)
    { return detail::get_var<Container>(ncid, varid); }
